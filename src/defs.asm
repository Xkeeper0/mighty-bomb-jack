...
; enum DoorFlag	(bitfield) (width 1 byte)
...
; +-------------------------------------------------------------------------+
;
; Input	MD5   :	F1C7732E3D4BC83AE596BD3ABA9902F1
; Input	CRC32 :	FD064014

; File Name   :	C:\Users\Revya\Documents\Emulation\ROMs\NES\Mighty Bomb Jack (Japan).nes
